...
class Test(unittest.TestCase):
   ...
   responses.add(responses.GET, 'https://www.wallandbinkley.com/rcb/tiles/images/world-0001/info.json',
                  json=json.loads('{"@context":"http://iiif.io/api/image/2/context.json","@id":"https://www.wallandbinkley.com/rcb/tiles/images/world-0001","protocol":"http://iiif.io/api/image","width":1784,"height":3282,"sizes":[{"width":1784,"height":3282},{"width":136,"height":250}],"profile":["http://iiif.io/api/image/2/level0.json",{"supports":["cors","sizeByWhListed","baseUriRedirect"]}],"tiles":[{"width":512,"scaleFactors":[1,2,4,8]}]}'), 
                  status=200)
